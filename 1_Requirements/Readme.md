...
# WORKING PROCESS
* The RED LED is considered for the ACC position. Once the push buttn is pressed for 2 seconds, the RED LED keeps continuously glowing until the stop of the engine signifying the engine condition to be turned ON.
